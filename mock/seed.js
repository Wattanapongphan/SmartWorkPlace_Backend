...
async function seed() {
    ...
    await seatSchema.create([
        ...
        {_id: '2', tableNumber: '2', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP2'},
        {_id: '3', tableNumber: '3', status: 'available', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP3'},
        {_id: '4', tableNumber: '4', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP4'},
        {_id: '5', tableNumber: '5', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP5'},
        {_id: '6', tableNumber: '6', status: 'available', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP6'},
        {_id: '7', tableNumber: '7', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP7'},
        {_id: '8', tableNumber: '8', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP8'},
        {_id: '9', tableNumber: '9', status: 'available', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP9'},
        {_id: '10', tableNumber: '10', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP10'},
        {_id: '11', tableNumber: '11', status: 'occupied', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP11'},
        {_id: '12', tableNumber: '12', status: 'available', zone_id: 'cnx-stp-3-A0', employee_id: 'EMP12'},
