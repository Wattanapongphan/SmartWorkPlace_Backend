...
exports.getSelectFloors = async (req, res) => {
  try {
    const allFloors = [
      ...
      { id: "bkk-1-2", name: "ชั้น 2", floor: "bkk-1" },
      { id: "bkk-2-1", name: "ชั้น 1", floor: "bkk-2" },
      { id: "kkc-1-1", name: "ชั้น 1", floor: "kkc-1" },
      { id: "kkc-1-2", name: "ชั้น 2", floor: "kkc-1" },
      { id: "kkc-2-1", name: "ชั้น 1", floor: "kkc-2" },
      { id: "hdy-1-1", name: "ชั้น 1", floor: "hdy-1" },
      { id: "hdy-1-2", name: "ชั้น 2", floor: "hdy-1" },
      { id: "hdy-2-1", name: "ชั้น 1", floor: "hdy-2" },
      { id: "sri-1-1", name: "ชั้น 1", floor: "sri-1" },
      { id: "sri-1-2", name: "ชั้น 2", floor: "sri-1" },
      { id: "sri-2-1", name: "ชั้น 1", floor: "sri-2" },
    ];
    ...
    if (!floor || floor === "all") {
      return res.status(200).json({
        ...
        data: allFloors.map((f) => ({ id: f.id, name: f.name })),
      });
    } else {
